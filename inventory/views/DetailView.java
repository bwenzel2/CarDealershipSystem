...
public class DetailView extends javax.swing.JFrame implements View {
    ...
    private InventoryCarModel car;
    private Set<InventoryCarModel> carModels;

    public DetailView(InventoryPresenter view, InventoryCarModel car) {
        this.mainview = view;
        this.car = car;
    ...
    private void okButtonActionPerformed(ActionEvent e) {
        View new_view = new InventoryMainView(carModels, this.mainview);
